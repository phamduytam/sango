...
<div>
	<div class="col-lg-6">
		<form method="get" id="form" action="<?php echo url('menu2')?>">
	...
	<div class="col-lg-3 pull-right">
		<p class="text-right">
			<a href="<?php echo url('menu2/add')?>"><button class="btn btn-primary" type="button">Add</button></a>
		</p>
	</div><!-- /input-group -->
</div><!-- /.col-lg-6 -->
</div>
...
<table class="table table-bordered table-hover table-striped tablesorter">
	<thead>
		<tr>
			...
			<th>Menu cấp 1 <i class="fa fa-sort"></i></th>
