...
<ol class="breadcrumb">
	<li class="active"><i class="fa fa-star-o"></i> <a>Dịch vụ </a></li>
</ol>
<div class="table-responsive">
<div class="row">
	<div class="col-lg-6">
		<form method="get" id="form" action="/admin/dichvu">
	...
	<div class="col-lg-3 pull-right">
		<p class="text-right">
			<a href="<?php echo url('dichvu/add')?>"><button class="btn btn-primary" type="button">Add</button></a>
		</p>
	</div><!-- /input-group -->
</div><!-- /.col-lg-6 -->
</div>
