			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					<li <?php echo $this->id == 'site' ? 'class="active"' : ''?>><a href="<?php echo app()->baseUrl?>"><i class="fa fa-dashboard"></i>
							Dashboard</a></li>
					<li <?php echo $this->id == 'product' ? 'class="active"' : ''?>><a href="<?php echo app()->baseUrl?>/product"><i class="fa fa-star-o"></i> Sản Phẩm </a></li>
					<li <?php echo $this->id == 'tuvan' ? 'class="active"' : ''?>><a href="<?php echo app()->baseUrl?>/tuvan"><i class="fa fa-star-o"></i> Tư vấn</a></li>
					<li <?php echo $this->id == 'dichvu' ? 'class="active"' : ''?>><a href="<?php echo app()->baseUrl?>/dichvu"><i class="fa fa-bell"></i> Dịch Vụ </a></li>
					<li <?php echo $this->id == 'contact' ? 'class="active"' : ''?>><a href="<?php echo app()->baseUrl?>/contact"><i class="fa fa-envelope-o"></i> Liên hệ </a></li>
					<li <?php echo $this->id == 'static' ? 'class="active"' : ''?>><a href="<?php echo app()->baseUrl?>/static"><i class="fa fa-life-ring"></i> Trang đơn</a></li>
					<li class="dropdown <?php echo ($this->id == 'advertise' || $this->id == 'category') ? 'active open' : '';?>"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"><i class="fa fa-caret-square-o-down"></i>
							Hình ảnh - Banner <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li <?php echo $this->id == 'category' ? 'class="active"' : ''?>><a href="<?php echo app()->baseUrl?>/category"><i class="fa fa-sliders"></i> Danh sách </a></li>
							<li <?php echo $this->id == 'advertise' ? 'class="active"' : ''?>><a href="<?php echo app()->baseUrl?>/advertise"><i class="fa fa-image"></i> List Image</a></li>
						</ul></li>
				</ul>
<?php
				...
				<ul class="nav navbar-nav navbar-right navbar-user">
					<li class="dropdown messages-dropdown"><a href="#"
						...
						<ul class="dropdown-menu">
							...
							<li class="message-preview"><a href="<?php echo app()->baseUrl?>/contact/view/<?php echo $value->id?>"> <span class="avatar"><img
