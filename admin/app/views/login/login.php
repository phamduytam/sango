                ...
                <div id="container_demo">
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="admin/signin" autocomplete="on" method="post" role="form">
                                <h3 class="black_bg">
                                    <img src="assets/img/logo.png" alt="josh logo">
                                    <br>Log in</h3>
                                    <!-- CSRF Token -->
                                    <input type="hidden" name="_token" value="dGzfqE4eTWh1ttUgzC0CpLuj3k6npAqi39yGFAyf" />
                                ...
                                <div class="form-group ">
                                    ...
                                    <input id="email" name="email" required type="email" placeholder="E-mail" value="" />
                                    <div class="col-sm-12">
                        ...
                        <div id="register" class="animate form">
                            <form action="admin/signup" autocomplete="on" method="post" role="form">
                                <h3 class="black_bg">
                                    <img src="assets/img/logo.png" alt="josh logo">
                                    <br>Sign Up</h3>
                                    <!-- CSRF Token -->
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input id="first_name" name="first_name" required type="text" placeholder="John" value="" />
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input id="last_name" name="last_name" required type="text" placeholder="Doe" value="" />
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input id="email" name="email" required type="email" placeholder="mysupermail@mail.com" value="" />
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input id="email_confirm" name="email_confirm" required type="email" placeholder="mysupermail@mail.com" value="" />
                                        <div class="col-sm-12">
                        ...
                        <div id="forgot" class="animate form">
                            <form action="admin/forgot-password" autocomplete="on" method="post" role="form">
                                <h3 class="black_bg">
                                    <img src="assets/img/logo.png" alt="josh logo">Password</h3>
                                <p>
