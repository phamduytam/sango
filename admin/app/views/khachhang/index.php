...
<div>
	<div class="col-lg-6">
		<form method="get" id="form" action="<?php echo app()->baseUrl?>/khachhang">
	...
	<div class="col-lg-3 pull-right">
		<p class="text-right">
			<a href="<?php echo url('khachhang/add')?>"><button class="btn btn-primary" type="button">Add</button></a>
		</p>
	</div><!-- /input-group -->
</div><!-- /.col-lg-6 -->
</div>
