...
<ol class="breadcrumb">
	<li class="active"><i class="fa fa-sliders"></i> <a>Thương Hiệu</a></li>
</ol>
<div class="table-responsive">
<div class="row">
	<div class="col-lg-6">
		<form method="get" id="form" action="/admin/thuonghieu">
	...
	<div class="col-lg-3 pull-right">
		<p class="text-right">
			<a href="<?php echo url('thuonghieu/add')?>"><button class="btn btn-primary" type="button">Add</button></a>
		</p>
	</div><!-- /input-group -->
</div><!-- /.col-lg-6 -->
</div>
