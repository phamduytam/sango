...
class DichVuAR extends BaseAR
{
	...
	private function getCriteriaListDichVu()
	{
		$criteria = new CDbCriteria();
		$criteria->select = '*';
	...
	public function searchListDichVu($pageSize = 20, $maxPage = -1)
	{
		$criteria = $this->getCriteriaListDichVu();
