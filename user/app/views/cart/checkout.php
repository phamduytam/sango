<form method="post" action="" data-toggle="validator" class="content stateful-form formCheckout" novalidate="true">
        <div class="wrap" context="checkout" define="{checkout: new Bizweb.StoreCheckout(this,{ token: &quot;6f4c1ab3b8924284970ca0d585adb492&quot;, email: &quot;&quot;, totalOrderItemPrice: 588000.0000, shippingFee: 0, freeShipping: false, requiresShipping: true, existCode: false, code: &quot;&quot;, discount: 0, settingLanguage: &quot;vi&quot;, moneyFormat: &quot;{{amount_no_decimals_with_comma_separator}}₫&quot;, discountLabel: &quot;Miễn phí&quot;, districtPolicy: &quot;optional&quot;, district: &quot;&quot;, province:&quot;&quot;, otherAddress: false, shippingId: 0, shippingMethods: [], customerAddressId: 0, reductionCode: &quot;&quot; })}">
            <div class="sidebar ">
                                                ...
                                                <td>
                                                    <div class="product-thumbnail">
                                                        <div class="product-thumbnail__wrapper">
                                                                ...
                                                                <img src="//bizweb.dktcdn.net/thumb/thumb/100/054/978/products/8.jpg?v=1455936444700" class="product-thumbnail__image">
                                                ...
                                                <td>
                                                    <div class="product-thumbnail">
                                                        <div class="product-thumbnail__wrapper">
                                                                ...
                                                                <img src="//bizweb.dktcdn.net/thumb/thumb/100/054/978/products/4-8212ca6f-01ff-46cc-9839-049ae749a6ec.jpg?v=1455936357300" class="product-thumbnail__image">
                    ...
                    <div class="order-summary order-summary--total-lines">
                        <div class="summary-section border-top-none--mobile">
                            <div class="total-line total-line-subtotal clearfix">
                                ...
                                <span bind="money(totalOrderItemPrice - discount,'{{amount_no_decimals_with_comma_separator}}₫')" class="total-line-subprice pull-right">588.000₫</span>
                            </div>
                            <div class="total-line total-line-shipping clearfix" bind-show="requiresShipping">
                                <span class="total-line-name pull-left">
                                    Phí vận chuyển
                                </span>
                                <span bind="shippingFee >  0 ? money(shippingFee,'{{amount_no_decimals_with_comma_separator}}₫') : ((requiresShipping &amp;&amp; shippingMethods.length == 0) ? 'Khu vực này không hỗ trợ vận chuyển': 'Miễn phí')" class="total-line-shipping pull-right hide" bind-show="ShippingProvinceId || BillingProvinceId &amp;&amp; !otherAddress || (requiresShipping &amp;&amp; shippingMethods.length > 0)">Khu vực này không hỗ trợ vận chuyển</span>
                            </div>
                            <div class="total-line total-line-total clearfix">
                                <span class="total-line-name pull-left">
                                    Tổng cộng
                                </span>
                                <span bind="money(totalOrderItemPrice + (isNaN(shippingFee) ? 0 : shippingFee) - discount,'{{amount_no_decimals_with_comma_separator}}₫')" class="total-line-price pull-right">588.000₫</span>
                            </div>
                        </div>
                    </div>
    ...
    <div class="content-box__row">
        <div class="radio-wrapper">
            <div class="radio__input">
                <input class="input-radio" type="radio" value="57674" name="PaymentMethodId" id="payment_method_57674" data-check-id="4" bind="payment_method_id" checked="">
            </div>
            <label class="radio__label" for="payment_method_57674">
        ...
        <div class="radio-wrapper content-box__row content-box__row--secondary" id="payment-gateway-subfields-57674" bind-show="payment_method_id == 57674">
...
<script src='<?php echo app()->baseUrl;?>/assets/themes_support/twine.min.js?20171025' type='text/javascript'></script>
<script src='<?php echo app()->baseUrl;?>/assets/themes_support/validator.min.js?20171025' type='text/javascript'></script>
<script src='<?php echo app()->baseUrl;?>/assets/themes_support/nprogress.js?20171025' type='text/javascript'></script>
<script src='<?php echo app()->baseUrl;?>/assets/themes_support/money-helper.js?20171025' type='text/javascript'></script>

<script src='<?php echo app()->baseUrl;?>/assets/themes_support/checkout.js?20180327' type='text/javascript'></script>
