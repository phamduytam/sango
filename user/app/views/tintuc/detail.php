			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="article-image" itemprop="image">
					<a href="">
						...
						<img class="img-responsive" src="<?php echo app()->baseUrl?>/uploads/<?php echo $tintuc->image?>" alt="<?php echo $tintuc->name ?>">

					</a>
				</div>
				<h1 class="article-title" itemprop="name">
					<a href=""><?php echo $tintuc->name ?></a>
				</h1>
				<p class="article-info">
					<span>
						<i class="fa fa-clock-o"></i> <?php echo $tintuc->created ?></span>
				</p>
